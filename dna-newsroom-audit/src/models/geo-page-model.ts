import { GeoPageRequirement, Priority, SiteMode } from './types';

export const GEO_PAGE_MODEL: GeoPageRequirement[] = [
  // ============================================
  // TRUST & ENTITY PAGES
  // ============================================
  {
...
export function getRequirementsForMode(mode: SiteMode): GeoPageRequirement[] {
  return GEO_PAGE_MODEL
...
export function getEffectivePriority(req: GeoPageRequirement, mode: SiteMode): Priority {
  const weight = req.weight[mode];
  if (weight >= 1.3 && req.priority === 'P2') return 'P1';
  if (weight <= 0.3 && req.priority === 'P1') return 'P2';
  return req.priority;
}
